...
async function callGeminiAi(promptText, imageBase64 = null, mimeType = "image/jpeg", retries = 3, delay = 1000) {
  if (!supabaseClient) {
  ...
  for (let i = 0; i < retries; i++) {
    try {
      ...
      // Extract string payload safely regardless of response envelope shape
      ...
      // Wait before retrying (exponential delay: 1s, 2s, 4s...)
